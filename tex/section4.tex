...
Разработена е архитектура за софтуерно решение за платформа за визуализация на ултразвукови компоненти в 3 измерения.  Описани са модулите, които съставят базовите компоненти на системата и са описани връзките между тях. Предоставени са илюстрации и диаграми, които описват работата на системата и архитектурата на модулите. 